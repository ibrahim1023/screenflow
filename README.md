...
- Provides a Pack Execution screen with per-step progress and output artifact paths
- Includes a Settings screen for cloud drafting toggle, data retention policy, and privacy mode
